image:https://circleci.com/gh/snowdrop/spring-boot-cache-booster.svg?style=shield["CircleCI", link="https://circleci.com/gh/snowdrop/spring-boot-cache-booster"]
